package at.htlwels.DIPLOMARBEITSTITEL.compiler.cmm;
...
//##################################################################################
	...
	void CMM() {
		...
		while (la.kind == 1 || la.kind == 22 || la.kind == 25) {
			if (isVarDecl()) {
				VarDecl();
			} else if (la.kind == 25) {
				ConstDecl();
	...
	Obj  ProcDecl() {
		...
		Expect(6);
		if (la.kind == 1 || la.kind == 30) {
			Obj param1 = Parameter();
			symbolTable.insert(param1);procedure.nPars++; 
			while (la.kind == 26) {
				Get();
				Obj paramN = Parameter();
				symbolTable.insert(paramN);procedure.nPars++; 
			}
		}
		Expect(7);
		if (la.kind == 23) {
	...
	Node  Statement() {
		Node  statement;
		statement=null;Node expression=null; NodeList innerStatements=new NodeList();
		if (isCall()) {
			statement = ProcCall();
		} else if (la.kind == 1) {
	...
	Node  Designator() {
		Node  designator;
		String name = Ident();
		Obj obj=symbolTable.find(name);designator=new Node(obj);
		while (la.kind == 27 || la.kind == 38) {
			if (la.kind == 38) {
				Get();
				String name2 = Ident();
	...
	Node  Term() {
		...
		term = Factor();
		while (la.kind == 17 || la.kind == 18 || la.kind == 39) {
			kind = Mulop();
			faktor = Factor();
	...
	private static final boolean[][] set = {
		...
		{_x,_T,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_T, _x,_x,_x,_x, _x,_x,_x,_T, _T,_T,_x,_T, _x,_x,_x,_x, _x,_x,_x,_x},
		{_x,_T,_T,_T, _T,_T,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _T,_T,_x,_x, _x,_x,_x,_x}
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 29: s = "\"forward\" expected"; break;
			case 30: s = "\"ref\" expected"; break;
			case 31: s = "\"print\" expected"; break;
			case 32: s = "\"while\" expected"; break;
			case 33: s = "\"if\" expected"; break;
			case 34: s = "\"else\" expected"; break;
			case 35: s = "\"return\" expected"; break;
			case 36: s = "\"readInt\" expected"; break;
			case 37: s = "\"readChar\" expected"; break;
			case 38: s = "\".\" expected"; break;
			case 39: s = "\"%\" expected"; break;
			case 40: s = "\"||\" expected"; break;
			case 41: s = "\"&&\" expected"; break;
			case 42: s = "??? expected"; break;
			case 43: s = "invalid ConstDecl"; break;
			...
			case 49: s = "invalid CondFact"; break;
