...
public class Scanner {
	...
	static {
		...
		for (int i = 48; i <= 57; ++i) start.set(i, 25);
		start.set(39, 6); 
		start.set(34, 10); 
		start.set(40, 12); 
		start.set(41, 13); 
		...
		loop: for (;;) {
			switch (state) {
				...
				case 25:
					...
					if (ch >= '0' && ch <= '9') {AddCh(); state = 25; break;}
				...
				case 30:
					if (ch == 167) {AddCh(); state = 31; break;}
					else {state = 0; break;}
				case 31:
				...
				case 40:
					...
					else if (ch == 'i') {AddCh(); state = 33; break;}
					else if (ch == 'c') {AddCh(); state = 34; break;}
